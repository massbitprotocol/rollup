...
use zkevm_circuits::table::BlockTable;
use zkevm_circuits::table::TxFieldTag;
use zkevm_circuits::table::TxTable;
use zkevm_circuits::util::{
...
mod pi_circuit_test {
    ...
    use crate::circuits::test_util::rand_tx;
    use halo2_proofs::{
