...
use crate::circuits::circuit_builder::{self, keccak_inputs, CircuitsParams};
...
impl From<&circuit_builder::Block> for BlockContext {
    fn from(block: &circuit_builder::Block) -> Self {
        Self {
...
pub fn block_convert(
    block: &circuit_builder::Block,
    code_db: &circuit_builder::state_db::CodeDB,
    ...
    Ok(Block {
        ...
        keccak_inputs: keccak_inputs(block, code_db)?,
