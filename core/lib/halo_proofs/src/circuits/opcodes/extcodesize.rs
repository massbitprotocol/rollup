...
use bus_mapping::operation::{AccountField, CallContextField, TxAccessListAccountOp, RW};
...
mod extcodesize_tests {
    use super::*;
    use crate::circuits::BlockData;
    use bus_mapping::circuit_input_builder::ExecState;
    use bus_mapping::operation::{AccountOp, CallContextOp, StackOp};
    use eth_types::evm_types::{OpcodeId, StackAddress};
    use eth_types::geth_types::{Account, GethData};
    use eth_types::{bytecode, Bytecode, Bytes, Word, U256};
    ...
    lazy_static! {
        /// Mock 1 ETH
        pub static ref MOCK_1_ETH: Word = super::eth(1);
    ...
    fn test_ok(account: &Account, is_warm: bool) {
        ...
        let mut builder = BlockData::new_from_geth_data(block.clone()).new_circuit_builder();
        builder
