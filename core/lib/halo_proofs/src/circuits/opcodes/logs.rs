...
use bus_mapping::circuit_input_builder::{ExecState, ExecStep};
use bus_mapping::operation::{CallContextField, TxLogField};
...
fn gen_log_step(state: &mut CircuitStateRef, geth_step: &GethExecStep) -> Result<ExecStep, Error> {
