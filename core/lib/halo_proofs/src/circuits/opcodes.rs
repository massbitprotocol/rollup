...
use bus_mapping::operation::{
    AccountField, CallContextField, TxAccessListAccountOp, TxReceiptField, RW,
};
// #[cfg(any(feature = "test", test))]
// pub use bus_mapping::sha3::sha3_tests::{gen_sha3_code, MemoryKind};
pub(crate) use self::sha3::Sha3;
use crate::circuits::circuit_builder::CircuitStateRef;
pub(crate) use address::Address;
pub(crate) use balance::Balance;
use bus_mapping::{
    error::{ExecError, OogError},
    operation::TxRefundOp,
    Error,
};
pub(crate) use calldatacopy::Calldatacopy;
pub(crate) use calldataload::Calldataload;
pub(crate) use calldatasize::Calldatasize;
pub(crate) use caller::Caller;
pub(crate) use callop::CallOpcode;
pub(crate) use callvalue::Callvalue;
pub(crate) use codecopy::Codecopy;
pub(crate) use codesize::Codesize;
use core::fmt::Debug;
pub(crate) use create::DummyCreate;
pub(crate) use dup::Dup;
pub(crate) use error_invalid_jump::ErrorInvalidJump;
pub(crate) use error_oog_call::OOGCall;
use eth_types::{
    evm_types::{GasCost, OpcodeId, MAX_REFUND_QUOTIENT_OF_GAS_USED},
    GethExecStep, ToAddress, ToWord, Word,
};
pub(crate) use exp::Exponentiation;
pub(crate) use extcodecopy::Extcodecopy;
pub(crate) use extcodehash::Extcodehash;
pub(crate) use extcodesize::Extcodesize;
pub(crate) use gasprice::GasPrice;
use keccak256::EMPTY_HASH;
use log::warn;
use logs::Log;
pub(crate) use mload::Mload;
pub(crate) use mstore::Mstore;
pub(crate) use origin::Origin;
pub(crate) use return_revert::ReturnRevert;
pub(crate) use returndatacopy::Returndatacopy;
pub(crate) use returndatasize::Returndatasize;
pub(crate) use selfbalance::Selfbalance;
pub(crate) use sload::Sload;
pub(crate) use sstore::Sstore;
pub(crate) use stackonlyop::StackOnlyOpcode;
...
type FnGenAssociatedOps =
    fn(state: &mut CircuitStateRef, geth_steps: &[GethExecStep]) -> Result<Vec<ExecStep>, Error>;
...
pub fn gen_begin_tx_ops(state: &mut CircuitStateRef) -> Result<ExecStep, Error> {
...
pub fn gen_end_tx_ops(state: &mut CircuitStateRef) -> Result<ExecStep, Error> {
